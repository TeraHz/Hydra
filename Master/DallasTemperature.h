...
class DallasTemperature
{
  ...
  // sends command for all devices on the bus to perform a temperature conversion. Will not wait. Make sure you wait before you read the temperature
  void requestTemperaturesNoDelay(void);
