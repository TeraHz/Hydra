...
$sqlQuery = "select m.date as date, m.value as value from Metrics m, Categories c where c.id = m.categoryId and c.name = '". $_GET['category']. "' order by date desc limit 30" ;
